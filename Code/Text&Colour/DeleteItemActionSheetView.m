...
@implementation DeleteItemActionSheetView
...
- (id)init {
    NSArray* nib = [[NSBundle mainBundle] loadNibNamed:@"DeleteItemActionSheetView" owner:self options:nil];
...
- (IBAction)deleteButtonPressed {
    [self.delegate deletItemButtonPressedInTableView:self.tableView atSwipeCellIndexPath:self.swipeCellIndexPath];
